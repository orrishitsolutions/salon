...
<div class="page-content">
   <div class="row mb-3">
      <div class="col-md-8">
         <h6 class="card-title">
            <i data-feather="users"></i> Management Team         
            <?php 
      ...
      <div class="col-md-4">
         <div class="d-flex justify-content-space-between">
            <button type="submit" form-id="form-category" class="btn btn-primary save" id="category_submit" value="Do you really want to Add/Edit Teams Abouts" >
               <i class="fa fa-save"></i>
               Save 
            </button>
            <a href="<?=base_url('admin/our-team')?>" class="btn btn-danger "><i class="fa fa-undo"></i>Back</a>
         </div>
      </div>
