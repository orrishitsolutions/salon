   ...
   <div class="row mb-3">
      ...
      <div class="col-md-4">
         <div class="Add-bottom">
            <a href="<?=base_url('admin/add-testimonials')?>" class="btn btn-danger">
               <i data-feather="users"></i>+ testimonials
            </a>
         </div>
      </div>
   </div>
                  ...
                  <table id="dataTableExample" class="table">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td >
                              <img src="<?=base_url()?>assets-orrish/storage/About-image/<?=$directors_select[$i]['file']?>" style="width: 70px;height: 70px;object-fit: contain;" >
                           </td>
                           <td>
                              <?php
                           ...
                           <td>
                              <div class="d-flex justify-content-start">
                                 <a href="<?=base_url()?>admin/edit-testimonials/<?=$directors_select[$i]['id']?>" class="btn btn-outline-success " >
