...
<div class="page-content">
   <div class="row mb-3">
      <div class="col-md-8">
         <h6 class="card-title">
            <i data-feather="users"></i>Our testimonials         
            <?php 
      ...
      <div class="col-md-4">
         <div class="d-flex justify-content-space-between">
            <button type="submit" form-id="form-category" class="btn btn-primary save" id="category_submit" value="Do you really want to Add/Edit Testimonials Abouts" >
               <i class="fa fa-save"></i>
               Save 
            </button>
            <a href="<?=base_url('admin/our-testimonials')?>" class="btn btn-danger "><i class="fa fa-undo"></i>Back</a>
         </div>
      </div>
            ...
            <div class="tab-pane fade active show" id="General" role="tabpanel" aria-labelledby="General-tab">
               <div class="card-body">
                  <div class="form-group required row">
                     ...
                     <div class="col-sm-10">
                        <input type="text" name="name" value="<?=$name?>" placeholder="Testimonials Name" id="name" class="form-control">
                     </div>
                  </div>

                   <div class="form-group required row">
                     <label class="col-sm-2 control-label" for="input-name1">Profile</label>
                     <div class="col-sm-10">
                        <input type="text" name="title2" value="<?=$title2?>" placeholder="Profile Name" id="name" class="form-control">
                     </div>
                  </div>
