	...
	<div class="row">
		...
		<div class="col-md-4 mb-4" style="text-align: right;">
			<div class="Add-bottom">
				<a href="<?= base_url('admin/add-products') ?>" class="btn btn-danger"><i class="fa fa-plus"></i> Add</a>
			</div>
		</div>
	</div>
	<div class="row">
						...
						<table id="dataTableExample" class="table">
							...
							foreach ($products as $valData) {
								...
								<tr>
									...
									<td>
										<?php
										if (!empty($valData->image)) {
											?>
											<img src="<?= base_url($valData->image) ?>"
												 style="width: 40px;height: 40px;object-fit: contain; background-color: #fff;">
											<?php
										}
										?>
									</td>
									<td><a href="<?= $valData->users_id; ?>" ><?= $valData->email; ?></a> </td>
