					...
					<div class="table-responsive">
						...
						<form class="cmxform" id="socialForm" method="post" action="<?= base_url('admin/'.$addPage); ?><?= !empty($data['param']) ? "/".$data['param'] : ""; ?>" enctype="multipart/form-data" >
							...
							<fieldset>
								...
								<div class="mb-3">
									<label for="title" class="form-label">Block ID
									</label>
									<input id="block_id" class="form-control" name="block_id" type="text" value="<?= !empty($data['block_id']) ? $data['block_id'] : "" ?>">
								</div>
								<div class="mb-3">
									<label for="content" class="form-label">Content</label>
									<textarea class="form-control" name="content" rows="10"><?= !empty($data['content']) ? $data['content'] : "" ?></textarea>
								</div>
								<div class="mb-3">
